                          ...
                          <h4 class="card-title">
                           ...
                           $countv1 = mysqli_query($connect,"select user_id from users") or die(mysqli_error($connect));
                                $countv1 = mysqli_num_rows($countv1);
                                    if(empty($countv1) >= 0){  ?>
                                    <div class="stat-digit"> <i class="fa fa-users"></i><h3><?php echo $countv1;?></h3></div>
                                     <?php } ?>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          ...
                          <h4 class="card-title">
                            <?php
                           $countv1 = mysqli_query($connect,"select id from my_gallery") or die(mysqli_error($connect));
                                $countv1 = mysqli_num_rows($countv1);
                                    if(empty($countv1) >= 0){  ?>
                                    <div class="stat-digit"> <i class="fa fa-users"></i><h3><?php echo $countv1;?></h3></div>
                                     <?php } ?>
