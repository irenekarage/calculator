...
// Fetch the existing details from the 'about' table
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="5" required><?= htmlspecialchars($about['description']) ?></textarea>
                                        </div>
                                        <button type="submit" class="btn btn" style="background-color:#212f3d;color:white;width:120px">Update</button>
