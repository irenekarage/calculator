        ...
        <div class="sidebar" data-background-color="dark">
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="dashboard.php" class="logo" style="color: white;">MY PORTFOLIO</a>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <a href="addPhoto.php"><button class="btn btn-secondary btn-round ms-auto">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    echo "<tr>";
                                                    echo "<td>{$row['id']}</td>";
                                                    echo "<td><img src='uploads/{$row['upload_photo']}' alt='Gallery Image' width='100'></td>";
                                                    echo "<td>{$row['description']}</td>";
                                                    echo "<td>{$row['created_at']}</td>";
                                                    echo "<td>
                                                            <a href='view.php?id={$row['id']}' class='btn btn- btn-sm'  style='background-color:#212f3d;color:white'><i class='fa fa-eye'></i></a>
                                                            <a href='deletephoto.php?id={$row['id']}' class='btn btn-danger btn-sm'><i class='fa fa-times'></i></a>
                                                          </td>";
                                                    echo "</tr>";
                                                }
                                                ?>
