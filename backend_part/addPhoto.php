    ...
    if (isset($_FILES['upload_photo']) && $_FILES['upload_photo']['error'] == 0) {
        ...
        if (in_array($fileExtension, $allowedExts)) {
            ...
            if (move_uploaded_file($fileTmpPath, $dest_path)) {
                $sql = "INSERT INTO my_gallery (upload_photo, description) VALUES (?, ?)";
                $stmt = $connect->prepare($sql);
                $stmt->bind_param("ss", $newFileName, $description);
        ...
        <div class="container">
            <div class="page-inner">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                    <div>
                        <h3 class="fw-bold mb-3">Add Photo to Gallery</h3>
                    </div>
                </div>
                            ...
                            <div class="card card-stats">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <textarea name="description" required class="form-control" placeholder="Enter photo description" rows="4" style="margin-left:15px;width:93%"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-stats">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <input type="file" name="upload_photo" required class="form-control" style="margin-left:15px;width:93%">
                                    </div>
                                </div>
                            </div>
                        </div>
