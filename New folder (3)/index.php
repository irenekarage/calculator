...
<body style="background-color: silver;">
        ...
        <div class="card">
            <h1 style="color:teal;margin-left: 100px;font-size: 30px;margin-top: 20px; text-shadow:maroon; ">STUDENT FIELD ENROLMENT</h1>
        
        </div>
        <div class="container-fluid" style="background-color:white;height: 400px;width:550px;margin-top:40px;">
        <div class="row">
        <div class ="col-md-12">
        <div class="card" style="margin-left: 20px; margin-top:20px; width:500px; height:10px; border-radius: 1px;"        >
                ...
                <br>
                <p>you have an account? <a href="register.php">register</p>

                <br>
                <p>Admin <a href="adminlogin.php">login</p>
